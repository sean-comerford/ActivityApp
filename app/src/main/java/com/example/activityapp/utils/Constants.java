...
public class Constants {
    ...
    // Broadcast strings for recording
    ...
    // **New Constants for ClassificationService**
    public static final String ACTION_CLASSIFICATION_UPDATE = "com.example.activityapp.CLASSIFICATION_UPDATE";
    public static final String EXTRA_ACTIVITY_RESULT = "activity";
    public static final String EXTRA_SOCIAL_SIGNAL_RESULT = "socialSignal";
}
